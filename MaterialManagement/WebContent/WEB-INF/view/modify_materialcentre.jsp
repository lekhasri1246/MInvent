...
<div id="container"><p style="text-align:left;">Modify Material Centre </p><div>
<form:form method="post" action="modify_materialcentre?mcId=${mcId}" id="vform">
Welcome
<fieldset>
...
<tr>	
	<td/>
	<td><br><input type="submit" value="Save Material Centre"/></td>
	<td/>
</tr>
