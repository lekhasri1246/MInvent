...
<div id="container"><p style="text-align:left;">Modify Unit </p><div>
<form:form method="post" action="modify_munit?munitId=${munitId}" id="vform">
Welcome
<fieldset>
...
<tr>	
	<td/>
	<td><br><input type="submit" value="Save Unit"/></td>
	<td/>
</tr>
