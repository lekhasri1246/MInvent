...
<div id="container"><p style="text-align:left;">Add Account Group</p><div>
<form:form method="post" action="add_AccountGroup" id="vform">
Welcome
<table class="left">
<tr>
...
<tr>	
	<td/>
	<td><br><input type="submit" value="Add Account Group"/></td>
	<td/>
</tr>
</table>
</form:form>
